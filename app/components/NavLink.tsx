...
const ACTIVE_ROUTE =
    "py-1 px-6 text-gray-300 bg-[#161616] rounded-full font-medium";
const INACTIVE_ROUTE =
    "transition duration-100 py-1 px-6 text-gray-500 hover:text-gray-300 hover:bg-[#424242] rounded-full";
