...
export default function TransactionsClient(props: { lastFiveIncomes: any; lastFiveExpenses: any }) {
    const lastFiveTransactions = [...props.lastFiveIncomes.incomes, ...props.lastFiveExpenses.expenses].sort((a: { date: any }, b: { date: any }) => new Date(b.date).getTime() - new Date(a.date).getTime()).slice(0, 5);
        ...
        <div className="p-6 bg-white dark:bg-lightGrayCustom3 border-[1px] border-lightBorder rounded-2xl text-sm select-none w-[25rem] h-[25rem]">
            ...
            <div className="mt-4">
                <div className="flex flex-col gap-2">
                    {lastFiveTransactions.map((transaction: any, index: number) => {
                                ...
                                {(transaction.type === "income" && (
                                    <div className="flex flex-row justify-between min-h-[3rem] items-center">
                                        <div className="rounded-full bg-newBlue-500 w-10 h-10 text-white flex items-center justify-center">
                                            ...
                                            {category === "Expense reimbursement" && <FaExchangeAlt size={17} />}
                                        ...
                                        <div className="text-sm text-newGreen-500 font-semibold">
                                            {"+ "}
                                    ...
                                    (transaction.type === "expense" && (
                                        <div className="flex flex-row justify-between min-h-[3rem] items-center">
                                            ...
                                            <div className="text-sm text-newRed-500 font-semibold">
                                                {"- "}
                                                {transaction.currency} {transaction.amount.toFixed(2)}
                                            </div>
                                        </div>
