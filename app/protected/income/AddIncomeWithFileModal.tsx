                ...
                <div className="fixed inset-0 overflow-y-auto">
                    <div className="flex items-center min-h-full justify-center p-4 text-center">
                        <Transition.Child as={Fragment} enter="ease-out duration-300" enterFrom="opacity-0 scale-95" enterTo="opacity-100 scale-100" leave="ease-in duration-200" leaveFrom="opacity-100 scale-100" leaveTo="opacity-0 scale-95">
                            <Dialog.Panel className="w-full max-w-3xl transform overflow-hidden rounded-2xl bg-[#313131] p-6 text-left align-middle shadow-xl transition-all">
                                            ...
                                            <table>
                                                <tbody>
                                                    <tr className="font-bold select-none">
                                                        ...
                                                        <td className="w-24">{gc?.date}</td>
                                                        <td className="w-24">{gc?.source}</td>
                                                        <td className="w-24">{gc?.amount}</td>
                                                        <td className="w-24">{gc?.currency}</td>
                                                        <td className="w-24">{gc?.category}</td>
                                                        <td className="w-24">{gc?.notes}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td className="w-24">
                                                                                    <select
                                                                                        ...
                                                                                        className="w-20 bg-transparent text-white focus:outline-none dark:
                                            [color-scheme:dark]"
                                                                                        onChange={(e) => {
                                                                ...
                                                                <li key={index} className="py-1">
                                                                    <table className="w-full text-left text-orange-500 line-through">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td className="w-24 text-center">
                                                                                    <input type="checkbox" className="h-[1.1rem] w-[1.1rem]" />
                                                                                </td>
                                ...
                                <div className="flex mt-4 justify-between">
                                    ...
                                    <div className="flex flex-row gap-3 items-center">
                                        <div className="select-none">
                                            <div>
                                                {gc?.selectedCount}{":"} <span>{selectedEntries}</span>
                                            </div>
                                        </div>
