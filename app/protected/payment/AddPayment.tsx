  ...
  return (
    <div ref={elementRef} className="p-5 bg-lightGrayCustom3 border-[1px] border-[#383b40] max-w-80 rounded-2xl text-sm select-none h-min">
      ...
      <div className="pb-2 flex flex-row gap-4">
        ...
        <div className="flex flex-col w-1/2">
          {gc?.currency}
          <select required ref={currencyRef} className="w-full bg-darkGrayCustom2 border-[1px] border-[#383b40] rounded-md px-2 py-[0.65rem] cursor-pointer hover:bg-lightGrayCustom3 transition duration-100 dark:[color-scheme:dark] focus:outline-none">
